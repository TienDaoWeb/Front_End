...
function HomePageRank() {
  return (
    <div className="Homepage__rank gap-[20px]">
      <div className="Homepage__rank--reading_week w-[90%]">
      ...
      <div className="Homepage__rank--trending_week w-[90%]">
      ...
      <div className="Homepage__rank--nominating_week w-[90%]">
