...
function Footer() {
  return (
    <div className='Footer__wrapper xs:px-[4rem]'>
      <div className="Footer">
          ...
          <span className="Footer__web_introduction xs:text-left">Với Tiên đạo, mỗi trang truyện là một hành trình phiêu lưu đầy mê hoặc. Hãy để trí tưởng tượng của bạn bay bổng và khám phá những câu chuyện kỳ diệu, nơi các nhân vật sống động và thế giới kỳ ảo hiện ra trước mắt bạn.</span>
